...
public final class FabricCompanionCreatorScreen extends Screen {
    ...
    private void selectForm(CompanionForm form) {
        ...
        pushLiveAppearance(FabricNetworking.SettingsPayload.FLAG_FORM
                | FabricNetworking.SettingsPayload.FLAG_FORM_VARIANT);
        init();
    }
    ...
    private void commitAndClose() {
        ...
        int flags = FabricNetworking.SettingsPayload.FLAG_NAME | FabricNetworking.SettingsPayload.FLAG_SCALE
                ...
                | FabricNetworking.SettingsPayload.FLAG_FORM | FabricNetworking.SettingsPayload.FLAG_FORM_VARIANT
                | FabricNetworking.SettingsPayload.FLAG_SHOW_NAME
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        try {
            InventoryScreen.renderEntityInInventoryFollowsMouse(
                    ...
                    previewY + previewH - 20,
                    (int) (48 * draft.scale / FabricCompanionEntity.DEFAULT_BODY_SCALE),
                    (float) (previewX + PREVIEW_W / 2) - mouseX,
                    (float) (previewY + previewH / 2) - mouseY,
                    companion);
