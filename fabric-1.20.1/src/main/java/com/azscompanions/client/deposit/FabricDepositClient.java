        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (client.screen instanceof PauseScreen) {
                client.setScreen(null);
                {
                    ...
                    FabricNetworking.DepositExitPayload.write(buf, new FabricNetworking.DepositExitPayload());
                    ClientPlayNetworking.send(FabricNetworking.DepositExitPayload.ID, buf);
                }
