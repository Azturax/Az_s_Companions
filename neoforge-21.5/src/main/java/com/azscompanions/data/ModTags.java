...
public final class ModTags {
    ...
    public static final class Blocks {
        ...
        private static TagKey<Block> block(String path) {
            return TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(AzsCompanions.MOD_ID, path));
        }
    }
    ...
    public static final class Items {
        ...
        private static TagKey<Item> item(String path) {
            return TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(AzsCompanions.MOD_ID, path));
        }
    }
    ...
    public static final class EntityTypes {
        ...
        private static TagKey<EntityType<?>> entity(String path) {
            return TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(AzsCompanions.MOD_ID, path));
        }
    }
}
