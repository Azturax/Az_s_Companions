...
public final class AzsCompanions {
    ...
    public static final com.azscompanions.platform.LoaderPlatform PLATFORM =
            com.azscompanions.platform.LoaderPlatform.FORGE;

    public AzsCompanions() {
        ...
        MinecraftForge.EVENT_BUS.register(CompanionGameEvents.class);
        ...
        MinecraftForge.EVENT_BUS.register(com.azscompanions.event.CompanionInvincibilityEvents.class);
        ...
        MinecraftForge.EVENT_BUS.register(com.azscompanions.event.CompanionPlayerDataEvents.class);
        MinecraftForge.EVENT_BUS.register(com.azscompanions.event.CompanionDimensionTravelEvents.class);
        MinecraftForge.EVENT_BUS.register(com.azscompanions.event.CompanionCreeperCatScareEvents.class);
        MinecraftForge.EVENT_BUS.register(com.azscompanions.event.CompanionSkeletonWolfScareEvents.class);
        com.azscompanions.ai.NeoAiJoinOfferEvents.bootstrap();

        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, CommonConfig.SPEC);
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, AiConfig.SPEC, AiConfig.FILE_NAME);
    ...
    private void onServerStarting(ServerStartingEvent event) {
        ...
        for (var recipe : event.getServer().getRecipeManager().getRecipes()) {
            var result = recipe.getResultItem(event.getServer().registryAccess());
            if (result.isEmpty()) {
                continue;
            }
