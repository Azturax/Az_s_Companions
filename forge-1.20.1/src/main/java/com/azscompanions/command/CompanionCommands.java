...
public final class CompanionCommands {
        ...
        return Commands.literal("az")
                ...
                .then(Commands.literal("customize")
                        .executes(ctx -> {
                            ...
                            com.azscompanions.network.ModNetworking.sendToPlayer(
                                    player,
    ...
    private static int personaEdit(ServerPlayer player, String nameOrNull) {
        ...
        com.azscompanions.network.ModNetworking.sendToPlayer(player, OpenCompanionPersonaPacket.fromCompanion(companion));
        return 1;
    }
    ...
    private static int openStats(ServerPlayer player, String nameOrNull) {
        ...
        com.azscompanions.network.ModNetworking.sendToPlayer(player, OpenCompanionStatsPacket.from(player, companion));
        return 1;
    }
