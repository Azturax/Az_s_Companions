...
public record CompanionSettingsPacket(
    ...
    public static void encode(CompanionSettingsPacket packet, FriendlyByteBuf buf) {
    ...
    public static CompanionSettingsPacket decode(FriendlyByteBuf buf) {
    ...
    public static void handle(CompanionSettingsPacket packet, java.util.function.Supplier<NetworkEvent.Context> ctx) {
