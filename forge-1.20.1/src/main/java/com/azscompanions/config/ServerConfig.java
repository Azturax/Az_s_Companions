...
public final class ServerConfig {
    ...
    public static final ForgeConfigSpec.IntValue MAX_COMPANIONS_PER_PLAYER;
    public static final ForgeConfigSpec.IntValue MAX_COMPANIONS_PER_SERVER;
    ...
    public static final ForgeConfigSpec.DoubleValue LOW_HEALTH_RETREAT_RATIO;
    public static final ForgeConfigSpec.BooleanValue LOG_TASK_EVENTS;
    public static final ForgeConfigSpec.BooleanValue STRICT_CHUNK_LOADING;
    public static final ForgeConfigSpec.BooleanValue COMPANION_CHUNK_LOADING;
    public static final ForgeConfigSpec.IntValue MAX_FORCED_CHUNKS_PER_PLAYER;
    public static final ForgeConfigSpec.DoubleValue HOME_BED_RADIUS;
    public static final ForgeConfigSpec.BooleanValue COMPANION_CHAT_MESSAGES;
    public static final ForgeConfigSpec.BooleanValue AUTO_EQUIP_TOOLS;
    public static final ForgeConfigSpec.BooleanValue ENABLE_AZ_ADMIN_COMMAND;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ADMIN_WHITELIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> AZ_ADMIN_USERS;
