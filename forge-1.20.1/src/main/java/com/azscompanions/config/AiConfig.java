...
public final class AiConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> API_KEY_ENV;
    public static final ForgeConfigSpec.ConfigValue<String> SYSTEM_PROMPT;
    public static final ForgeConfigSpec.ConfigValue<String> INPUT_LANGUAGE;
    public static final ForgeConfigSpec.IntValue TIMEOUT_SECONDS;
    public static final ForgeConfigSpec.IntValue CONNECT_TIMEOUT_SECONDS;
    public static final ForgeConfigSpec.IntValue MAX_TOKENS;
    public static final ForgeConfigSpec.IntValue MAX_INPUT_CHARS;
    public static final ForgeConfigSpec.IntValue QUEUE_MAX_DEPTH;
    public static final ForgeConfigSpec.IntValue MAX_PARALLEL_REQUESTS;
    public static final ForgeConfigSpec.BooleanValue ENABLE_CHAT_MESSAGES;
    public static final ForgeConfigSpec.BooleanValue SERVER_LLM_ONLY;
    public static final ForgeConfigSpec.BooleanValue INTEGRATED_MULTIPLAYER_SHARED_LLM;
    public static final ForgeConfigSpec.BooleanValue OWNER_NAME_FALLBACK;
    public static final ForgeConfigSpec.BooleanValue PER_COMPANION_MEMORY;
    public static final ForgeConfigSpec.IntValue MEMORY_MAX_MESSAGES;
    public static final ForgeConfigSpec.BooleanValue CENSOR_CHAT;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> CENSOR_EXTRA_WORDS;
    public static final ForgeConfigSpec.ConfigValue<String> CHAT_LISTEN_MODE;
    public static final ForgeConfigSpec.BooleanValue NAME_LISTEN;
    public static final ForgeConfigSpec.DoubleValue CHAT_REACT_RANGE;
    public static final ForgeConfigSpec.IntValue CHAT_REACT_COOLDOWN_SECONDS;
    public static final ForgeConfigSpec.BooleanValue IDLE_CHAT;
    public static final ForgeConfigSpec.BooleanValue REACTIVE_CHAT;
    public static final ForgeConfigSpec.BooleanValue ITEM_FIND_CHAT;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> CUSTOM_CHAT_EVENTS;
    public static final ForgeConfigSpec.IntValue IDLE_CHAT_SECONDS_MIN;
    public static final ForgeConfigSpec.IntValue IDLE_CHAT_SECONDS_MAX;
    public static final ForgeConfigSpec.BooleanValue CALL_PLAYER_WHEN_AWAY;
    public static final ForgeConfigSpec.IntValue CALL_PLAYER_AFTER_SECONDS;
    public static final ForgeConfigSpec.DoubleValue CALL_PLAYER_DISTANCE;
    public static final ForgeConfigSpec.IntValue CALL_PLAYER_COOLDOWN_SECONDS;
    public static final ForgeConfigSpec.BooleanValue ENABLE_AI_ACTIONS;
    public static final ForgeConfigSpec.IntValue AI_ACTION_REACH;
    public static final ForgeConfigSpec.IntValue AI_ACTION_COOLDOWN_TICKS;
    public static final ForgeConfigSpec.ConfigValue<String> CHILD_AUTONOMY;
    public static final ForgeConfigSpec.DoubleValue CHILD_LEASH_RADIUS;

    public static final ForgeConfigSpec.BooleanValue FTB_TEAMS_COMPAT;
    public static final ForgeConfigSpec.BooleanValue FTB_CHUNKS_ALLOW_PRESENCE;
    public static final ForgeConfigSpec.BooleanValue FTB_CHUNKS_BLOCK_INTERACTION;
    public static final ForgeConfigSpec.BooleanValue FTB_CHUNKS_AI_CLAIM;
    public static final ForgeConfigSpec.BooleanValue FTB_RANKS_COMPAT;
    public static final ForgeConfigSpec.BooleanValue TRUST_SAME_TEAM_AS_OWNER;
    public static final ForgeConfigSpec.ConfigValue<String> FTB_PERM_AI_ASK;
    public static final ForgeConfigSpec.ConfigValue<String> FTB_PERM_AI_ACTIONS;
    public static final ForgeConfigSpec.ConfigValue<String> FTB_PERM_CCI;
    public static final ForgeConfigSpec.ConfigValue<String> FTB_PERM_TEAMFIGHT;
    public static final ForgeConfigSpec.ConfigValue<String> FTB_PERM_SPAWN;

    public static final ForgeConfigSpec.ConfigValue<String> MCP_TRANSPORT;
    public static final ForgeConfigSpec.ConfigValue<String> MCP_URL;
    public static final ForgeConfigSpec.ConfigValue<String> MCP_COMMAND;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MCP_ARGS;
    public static final ForgeConfigSpec.ConfigValue<String> MCP_TOOL_NAME;
    public static final ForgeConfigSpec.ConfigValue<String> MCP_PROTOCOL_VERSION;
    public static final ForgeConfigSpec.ConfigValue<String> MCP_TOOL_ALLOWLIST;
    ...
    public static void saveSettingsToDiskWithoutReload(CompanionAiSettings s) throws java.io.IOException {
        java.nio.file.Path path = net.minecraftforge.fml.loading.FMLPaths.CONFIGDIR.get().resolve(FILE_NAME);
