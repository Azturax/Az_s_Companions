...
public final class CompanionBehaviorScreen extends Screen {
    ...
    public CompanionBehaviorScreen(CompanionEntity companion, Screen parent) {
    ...
    private void push() {
        ...
        com.azscompanions.network.ModNetworking.sendToServer(new CompanionBehaviorPacket(
    ...
    private final class SyncSlider extends AbstractSliderButton {
        ...
        protected void applyValue() {
            ...
            // Re-sync thumb if setter raised the value (e.g. wander floored to follow).
            syncFromField();
            push();
        }
    }
