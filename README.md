...
- **Release:** [v0.3.13](https://github.com/Azturax/Az_s_Companions/releases/tag/v0.3.13)
...
|--------|--------|-----|-------|
| **NeoForge** (standalone) | `:neoforge` | `azscompanions-neoforge-0.3.13+1.21.1.jar` | Default — no CCI |
| **NeoForge** (CCI) | `:neoforge-cci` | `azscompanions-neoforge-cci-0.3.13+1.21.1.jar` | Needs CCI + iChunUtil |
| **Fabric** (standalone) | `:fabric` | `azscompanions-fabric-0.3.13+1.21.1.jar` | Default — no CCI |
| **Fabric** (CCI) | `:fabric-cci` | `azscompanions-fabric-cci-0.3.13+1.21.1.jar` | Needs Fabric CCI + iChunUtil |
...
- **Admin:** `/az admin` · `/az ai config` (ops / host / whitelist) — editable LLM profiles + `serverLlmOnly`; save AI file (restart to apply) — [ADMIN.md](docs/ADMIN.md)
...
Outputs under `*/build/libs/azscompanions-*-0.3.13+1.21.1.jar`.
