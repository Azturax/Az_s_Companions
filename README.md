...
- **Release:** [v1.0.12](https://github.com/Azturax/Az_s_Companions/releases/tag/v1.0.12)
...
| Loader | Module | Jar |
|--------|--------|-----|
| NeoForge | `:neoforge` | `azscompanions-neoforge-1.0.12+1.21.1.jar` |
| Fabric | `:fabric` | `azscompanions-fabric-1.0.12+1.21.1.jar` |
...
| Loader | Module | Jar |
|--------|--------|-----|
| NeoForge | `:neoforge-21.5` | `azscompanions-neoforge-1.0.12+1.21.5.jar` |
| Fabric | `:fabric-21.5` | `azscompanions-fabric-1.0.12+1.21.5.jar` |
...
| Loader | Module | Jar |
|--------|--------|-----|
| Forge | `:forge-1.20.1` | `azscompanions-forge-1.0.12+1.20.1.jar` |
| Fabric | `:fabric-1.20.1` | `azscompanions-fabric-1.0.12+1.20.1.jar` |
...
| Loader | Module | Jar |
|--------|--------|-----|
| NeoForge 26.1.2 | `:neoforge-26-1` | `azscompanions-neoforge-1.0.12+26.1.2.jar` |
| NeoForge 26.2 | `:neoforge-26` | `azscompanions-neoforge-1.0.12+26.2.jar` |
...
Outputs under `*/build/libs/azscompanions-*-1.0.12+*.jar` (**8 jars** total).
...
3. Publish a GitHub Release, or run **Actions → Publish Modrinth / CurseForge** with tag `v1.0.12`
