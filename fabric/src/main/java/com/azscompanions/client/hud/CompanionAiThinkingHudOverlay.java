...
/**
 * Fabric top-right HUD: spinning gear + companion Thinking… + soft progress bar.
 */
public final class CompanionAiThinkingHudOverlay {
    ...
    public static void render(GuiGraphics graphics, float partialTick) {
        ...
        graphics.drawString(font, label, x + 28, y + 4, 0xFFE8E8F0, false);
        graphics.drawString(font, "Thinking...", x + 28, y + 14, 0xFFB0B0C0, false);
    ...
    private static void drawGear(GuiGraphics graphics, int cx, int cy, float radians) {
        int teeth = 8;
        float outer = 7.5f;
        float inner = 4.5f;
        float hub = 2.2f;
