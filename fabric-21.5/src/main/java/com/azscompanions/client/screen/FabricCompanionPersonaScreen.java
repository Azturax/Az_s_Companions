...
public final class FabricCompanionPersonaScreen extends Screen {
    ...
    public FabricCompanionPersonaScreen(
    ...
    private void drawScrollbar(GuiGraphics graphics) {
        ...
        graphics.fill(trackX, scrollbar.thumbY(), trackX + SCROLLBAR_W,
                scrollbar.thumbY() + scrollbar.thumbH(), color);
        graphics.fill(trackX, scrollbar.thumbY(), trackX + SCROLLBAR_W, scrollbar.thumbY() + 1, 0xFFFFFFFF);
    }
