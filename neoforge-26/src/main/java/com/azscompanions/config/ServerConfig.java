...
public final class ServerConfig {
    ...
    public static final ModConfigSpec.BooleanValue KEEP_INVENTORY_ON_DEATH;
    ...
    static {
        ...
        MAX_CHILD_COMPANIONS_PER_LEADER = builder
                .comment("Default max children per companion (living + stored), 1–64. Alias: maxChildrenPerCompanion. CCI maxChildren=/childCap= overrides per entity.")
