...
public final class FollowOwnerTask extends CompanionTask {
    ...
    protected TaskTickResult onTick(CompanionEntity companion, ServerLevel level) {
        ...
        double stop = CompanionFollowDistances.followStop(personal);
        ...
        } else if (CompanionFollowDistances.needsFollow(dist, personal, followRadius) && companion.isOwnerExploring()) {
        ...
        setProgress(100);
        return dist <= stop ? TaskTickResult.COMPLETED : TaskTickResult.RUNNING;
    }
}
