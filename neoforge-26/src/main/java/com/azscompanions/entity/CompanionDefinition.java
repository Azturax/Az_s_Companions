...
public record CompanionDefinition(
        ...
        String voiceProfile,
        Identifier defaultSkin,
        Identifier defaultOutfit,
    ...
    public static final Codec<CompanionDefinition> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Identifier.CODEC.fieldOf("id").forGetter(CompanionDefinition::id),
            ...
            Identifier.CODEC.fieldOf("defaultSkin").forGetter(CompanionDefinition::defaultSkin),
            Identifier.CODEC.optionalFieldOf("defaultOutfit",
                    Identifier.fromNamespaceAndPath("azscompanions", "textures/entity/companion/kon_outfit.png"))
