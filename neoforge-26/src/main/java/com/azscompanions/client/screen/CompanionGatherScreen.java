...
public final class CompanionGatherScreen extends Screen {
    ...
    private void start() {
        ...
        ClientPacketDistributor.sendToServer(new CompanionGatherAssignPacket(
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(font, title, panelX + (panelW - font.width(title)) / 2, panelY + 10, 0xFFFFFF);
        graphics.text(font, Component.translatable("screen.azscompanions.gather.item"),
                panelX + 16, panelY + 26, 0xA0A0A0);
        graphics.text(font, Component.translatable("screen.azscompanions.gather.count"),
                panelX + 16, panelY + 58, 0xA0A0A0);
        graphics.text(font, Component.literal("Deposit: " + depositMode),
                panelX + 16, panelY + 94, 0x80C0FF);
