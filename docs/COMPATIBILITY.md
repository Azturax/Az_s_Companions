...
Az's Companions ([repo](https://github.com/Azturax/Az_s_Companions), [v0.3.10](https://github.com/Azturax/Az_s_Companions/releases/tag/v0.3.10)) currently **ships and supports**:
...
|--------|--------|--------|
| NeoForge | `:neoforge` | Full 0.3.10 set (companions, AI, behavior, etc.) |
| NeoForge CCI | `:neoforge-cci` | Same + IMC bridge (needs CCI 1.13.0 + iChunUtil 1.0.3) |
| Fabric | `:fabric` | Full 0.3.10 set |
