...
public final class CommonConfig {
    ...
    static {
        ...
        TELEPORT_DISTANCE = builder.comment("Teleport to owner when farther than this (blocks). Follow starts ~32 and stops ~24; skipped while companion has a living combat target.")
