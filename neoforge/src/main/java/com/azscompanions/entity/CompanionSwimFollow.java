...
public final class CompanionSwimFollow {
    ...
    public static boolean isOwnerInWater(Player owner) {
        return owner != null
                && (owner.isSwimming() || owner.isUnderWater() || owner.isInWater() || owner.isInWaterOrBubble());
    }

    public static boolean isCompanionInWater(Mob companion) {
        return companion.isUnderWater() || companion.isInWater() || companion.isInWaterOrBubble();
    }
