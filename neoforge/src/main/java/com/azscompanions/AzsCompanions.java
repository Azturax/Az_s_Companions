...
public final class AzsCompanions {
    ...
    public AzsCompanions(IEventBus modBus, ModContainer container) {
        ...
        NeoForge.EVENT_BUS.register(com.azscompanions.event.CompanionInvincibilityEvents.class);
        NeoForge.EVENT_BUS.register(com.azscompanions.event.CompanionDeathEvents.class);
        ...
        NeoForge.EVENT_BUS.register(com.azscompanions.event.CompanionPlayerDataEvents.class);
