...
/**
 * Billboard glowing orb for {@link com.azscompanions.entity.CompanionForm#GLOWING_ORB}.
 * <p>
 * Sodium + Iris/Oculus safe: opaque cutout core (fullbright) plus {@link RenderType#eyes}
 * emissive pass. Avoids {@code entityTranslucent} / translucent-emissive paths that can
 * draw invisible under Iris Fabulous / deferred or Sodium without ETF.
 */
public final class CompanionOrbRenderer {
    ...
    /** Full block+sky light — same trick as eyes / beacon overlays. */
    ...
    public static void render(
        ...
        // Soft halo via eyes (shader emissive) then solid cutout core (never invisible).
