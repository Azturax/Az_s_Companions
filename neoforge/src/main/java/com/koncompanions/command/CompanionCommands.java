package com.koncompanions.command;
...
public final class CompanionCommands {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("koncompanions")
                ...
                .then(Commands.literal("customize")
                        .executes(ctx -> {
                            ...
                            net.neoforged.neoforge.network.PacketDistributor.sendToPlayer(
                                    player,
                                    new com.koncompanions.network.packet.OpenCompanionCreatorPacket(nearest.getId()));
                            return 1;
                        }))
        );
    }
    ...
    private static int recruit(CommandSourceStack source, String id) throws CommandSyntaxException {
        ...
        source.sendFailure(Component.translatable("message.koncompanions.limit_reached"));
        return 0;
    }
