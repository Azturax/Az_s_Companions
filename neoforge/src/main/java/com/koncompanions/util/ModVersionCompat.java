...
public final class ModVersionCompat {
    ...
    public static void logSupportBanner() {
        KonCompanions.LOGGER.info(
                "Kon Companions compatibility window: Minecraft {}–{}, NeoForge {}–{} | running MC {} / Neo {}",
        ...
        if (!isWithinSupportedWindow()) {
            KonCompanions.LOGGER.warn("Current game versions are outside the declared support window");
        }
    }
